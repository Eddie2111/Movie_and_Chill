...
progress=pro(w,style="red.Horizontal.TProgressbar",orient='horizontal',length=500,mode='determinate',)
...
Alabel0 = Label(root,text='Click the button to get a movie suggestion..!',font=('Ariel','15'),fg='orange',bg='Grey')
Alabel0.pack();
Abutton0 = Button(root,
